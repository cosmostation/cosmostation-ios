...
class KeyFac {
    ...
    static func getPubKeyFromPrivateKey(_ priKey: Data, _ pubKeyType: PubKeyType) -> Data? {
        if (pubKeyType == .COSMOS_Secp256k1 || pubKeyType == .ETH_Keccak256 || pubKeyType == .STRATOS_Keccak256 ||
            pubKeyType == .INJECTIVE_Secp256k1 || pubKeyType == .BERA_Secp256k1 || pubKeyType == .ARTELA_Keccak256 || pubKeyType == .INITIA_Keccak256) {
    ...
    static func getAddressFromPubKey(_ pubKey: Data, _ pubKeyType: PubKeyType, _ prefix: String? = nil, _ network: String? = nil) -> String {
        ...
        } else if (pubKeyType == .ETH_Keccak256 || pubKeyType == .STRATOS_Keccak256 || pubKeyType == .INJECTIVE_Secp256k1 || pubKeyType == .BERA_Secp256k1 || pubKeyType == .ARTELA_Keccak256 || pubKeyType == .INITIA_Keccak256) {
