...
class KavaSwpAction: BaseVC {
    
    @IBOutlet weak var titleLabel: UILabel!
    
    @IBOutlet weak var toSwpAssetCard: FixCardView!
    @IBOutlet weak var toSwpAssetTitle: UILabel!
    @IBOutlet weak var toSwpAssetImg: UIImageView!
    @IBOutlet weak var toSwpSymbolLabel: UILabel!
    @IBOutlet weak var toSwpAssetHint: UILabel!
