...
class PoolViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var mMyPoolList: Array<Osmosis_Gamm_V1beta1_BalancerPool> = Array<Osmosis_Gamm_V1beta1_BalancerPool>()
    var mOtherPoolList: Array<Osmosis_Gamm_V1beta1_BalancerPool> = Array<Osmosis_Gamm_V1beta1_BalancerPool>()
    ...
    func onCheckPoolJoin(_ pool: Osmosis_Gamm_V1beta1_BalancerPool) {
    ...
    func onCheckExitJoin(_ pool: Osmosis_Gamm_V1beta1_BalancerPool) {
