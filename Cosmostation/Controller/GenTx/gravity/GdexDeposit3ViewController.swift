//
//  GdexDeposit3ViewController.swift
//  Cosmostation
//
...
class GdexDeposit3ViewController: BaseViewController, PasswordViewDelegate {
    ...
    func onBroadcastGrpcTx(_ auth: Cosmos_Auth_V1beta1_QueryAccountResponse?) {
        DispatchQueue.global().async {
            let reqTx = Signer.genSignedDepositBatchMsgTxgRPC(auth!,
