...
extension BaseViewController {
    ...
    func onShowSelectChainDialog(_ cancleable: Bool) {
        ...
        let injectiveAction = UIAlertAction(title: NSLocalizedString("chain_title_injective", comment: ""), style: .default, handler: { _ in
            self.onChainSelected(ChainType.INJECTIVE_MAIN)
        })
        ...
        let cerberusAction = UIAlertAction(title: NSLocalizedString("chain_title_cerberus", comment: ""), style: .default, handler: { _ in
            self.onChainSelected(ChainType.CERBERUS_MAIN)
        })
        ...
        let nyxAction = UIAlertAction(title: NSLocalizedString("chain_title_nyx", comment: ""), style: .default, handler: { _ in
            self.onChainSelected(ChainType.NYX_MAIN)
        })
        nyxAction.setValue(UIImage(named: "chainNym")?.withRenderingMode(.alwaysOriginal), forKey: "image")
        ...
        showAlert.addAction(cerberusAction)
