...
class TxIncentiveEarnCell: TxCell {
    @IBOutlet weak var txIcon: UIImageView!
    @IBOutlet weak var incentiveEarnTitle: UILabel!
    ...
    override func awakeFromNib() {
        ...
        incentiveEarnTitle.text = NSLocalizedString("tx_kava_earn_incentive2", comment: "")
    ...
    override func onBindMsg(_ chainConfig: ChainConfig, _ response: Cosmos_Tx_V1beta1_GetTxResponse, _ position: Int) {
        ...
        if let msg = try? Kava_Incentive_V1beta1_MsgClaimEarnReward.init(serializedData: response.tx.body.messages[position].value) {
