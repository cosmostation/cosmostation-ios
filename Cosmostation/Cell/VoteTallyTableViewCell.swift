...
class VoteTallyTableViewCell: UITableViewCell {
    ...
    func onCheckDim() {
        ...
        progressYes.tintColor = UIColor(named: "_font04")
        ...
        progressNo.tintColor = UIColor(named: "_font04")
