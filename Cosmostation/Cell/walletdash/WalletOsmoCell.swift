...
class WalletOsmoCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        btnDefi.setTitle(NSLocalizedString("btn_osmodefi", comment: ""), for: .normal)
    ...
    func updateView(_ account: Account?, _ chainType: ChainType?) {
        ...
        totalValue.attributedText = WUtils.dpAssetValue(OSMOSIS_MAIN_DENOM, totalToken, 6, totalValue.font)
