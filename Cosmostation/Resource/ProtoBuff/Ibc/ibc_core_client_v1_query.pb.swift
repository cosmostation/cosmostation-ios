...
/// RPC method.
struct Ibc_Core_Client_V1_QueryConsensusStateHeightsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Ibc_Core_Client_V1_QueryConsensusStateHeightsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Ibc_Core_Client_V1_QueryConsensusStateHeightsRequest: @unchecked Sendable {}
extension Ibc_Core_Client_V1_QueryConsensusStateHeightsResponse: @unchecked Sendable {}
