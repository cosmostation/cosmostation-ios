...
struct Ibc_Core_Channel_V1_QueryNextSequenceSendRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Query/QueryNextSequenceSend RPC method
struct Ibc_Core_Channel_V1_QueryNextSequenceSendResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Ibc_Core_Channel_V1_QueryNextSequenceSendRequest: @unchecked Sendable {}
extension Ibc_Core_Channel_V1_QueryNextSequenceSendResponse: @unchecked Sendable {}
