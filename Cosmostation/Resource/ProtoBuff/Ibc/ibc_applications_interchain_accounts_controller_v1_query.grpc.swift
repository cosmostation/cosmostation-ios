...
extension Ibc_Applications_InterchainAccounts_Controller_V1_QueryClientProtocol {
  ...
  internal func interchainAccount(
    ...
    return self.makeUnaryCall(
      path: Ibc_Applications_InterchainAccounts_Controller_V1_QueryClientMetadata.Methods.interchainAccount.path,
      request: request,
...
internal struct Ibc_Applications_InterchainAccounts_Controller_V1_QueryNIOClient: Ibc_Applications_InterchainAccounts_Controller_V1_QueryClientProtocol {
...
internal protocol Ibc_Applications_InterchainAccounts_Controller_V1_QueryAsyncClientProtocol: GRPCClient {
  ...
  func makeInterchainAccountCall(
    _ request: Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountRequest, Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountResponse>
...
extension Ibc_Applications_InterchainAccounts_Controller_V1_QueryAsyncClientProtocol {
  internal func interchainAccount(
    _ request: Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountResponse {
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal struct Ibc_Applications_InterchainAccounts_Controller_V1_QueryAsyncClient: Ibc_Applications_InterchainAccounts_Controller_V1_QueryAsyncClientProtocol {
  internal var channel: GRPCChannel
  internal var defaultCallOptions: CallOptions
  internal var interceptors: Ibc_Applications_InterchainAccounts_Controller_V1_QueryClientInterceptorFactoryProtocol?
...
internal protocol Ibc_Applications_InterchainAccounts_Controller_V1_QueryClientInterceptorFactoryProtocol: Sendable {
...
internal enum Ibc_Applications_InterchainAccounts_Controller_V1_QueryClientMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Query",
    fullName: "ibc.applications.interchain_accounts.controller.v1.Query",
    methods: [
      Ibc_Applications_InterchainAccounts_Controller_V1_QueryClientMetadata.Methods.interchainAccount,
...
internal protocol Ibc_Applications_InterchainAccounts_Controller_V1_QueryProvider: CallHandlerProvider {
  var interceptors: Ibc_Applications_InterchainAccounts_Controller_V1_QueryServerInterceptorFactoryProtocol? { get }

  /// InterchainAccount returns the interchain account address for a given owner address on a given connection
  func interchainAccount(request: Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountResponse>
  ...
  internal func handle(
    ...
    case "InterchainAccount":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountRequest>(),
        responseSerializer: ProtobufSerializer<Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountResponse>(),
        interceptors: self.interceptors?.makeInterchainAccountInterceptors() ?? [],
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Ibc_Applications_InterchainAccounts_Controller_V1_QueryAsyncProvider: CallHandlerProvider {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Ibc_Applications_InterchainAccounts_Controller_V1_QueryServerInterceptorFactoryProtocol? { get }

  /// InterchainAccount returns the interchain account address for a given owner address on a given connection
  @Sendable func interchainAccount(
    request: Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountRequest,
...
extension Ibc_Applications_InterchainAccounts_Controller_V1_QueryAsyncProvider {
  ...
  internal var interceptors: Ibc_Applications_InterchainAccounts_Controller_V1_QueryServerInterceptorFactoryProtocol? {
    return nil
  }
...
internal protocol Ibc_Applications_InterchainAccounts_Controller_V1_QueryServerInterceptorFactoryProtocol {

  /// - Returns: Interceptors to use when handling 'interchainAccount'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeInterchainAccountInterceptors() -> [ServerInterceptor<Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountRequest, Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountResponse>]
...
internal enum Ibc_Applications_InterchainAccounts_Controller_V1_QueryServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Query",
    fullName: "ibc.applications.interchain_accounts.controller.v1.Query",
    methods: [
      Ibc_Applications_InterchainAccounts_Controller_V1_QueryServerMetadata.Methods.interchainAccount,
