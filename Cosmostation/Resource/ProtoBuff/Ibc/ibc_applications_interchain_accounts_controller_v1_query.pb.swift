...
struct Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountRequest {
...
struct Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Ibc_Applications_InterchainAccounts_Controller_V1_QueryParamsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Ibc_Applications_InterchainAccounts_Controller_V1_QueryParamsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountRequest: @unchecked Sendable {}
extension Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountResponse: @unchecked Sendable {}
extension Ibc_Applications_InterchainAccounts_Controller_V1_QueryParamsRequest: @unchecked Sendable {}
extension Ibc_Applications_InterchainAccounts_Controller_V1_QueryParamsResponse: @unchecked Sendable {}
