...
struct Ibc_Core_Connection_V1_QueryConnectionParamsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Ibc_Core_Connection_V1_QueryConnectionParamsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Ibc_Core_Connection_V1_QueryConnectionParamsRequest: @unchecked Sendable {}
extension Ibc_Core_Connection_V1_QueryConnectionParamsResponse: @unchecked Sendable {}
