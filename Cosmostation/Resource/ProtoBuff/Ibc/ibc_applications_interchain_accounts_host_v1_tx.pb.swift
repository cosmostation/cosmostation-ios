...
struct Ibc_Applications_InterchainAccounts_Host_V1_MsgModuleQuerySafe {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Ibc_Applications_InterchainAccounts_Host_V1_MsgModuleQuerySafeResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Ibc_Applications_InterchainAccounts_Host_V1_MsgModuleQuerySafe: @unchecked Sendable {}
extension Ibc_Applications_InterchainAccounts_Host_V1_MsgModuleQuerySafeResponse: @unchecked Sendable {}
