...
struct Cosmos_Feegrant_V1beta1_QueryAllowancesByGranterRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///
/// Since: cosmos-sdk 0.46
struct Cosmos_Feegrant_V1beta1_QueryAllowancesByGranterResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cosmos_Feegrant_V1beta1_QueryAllowanceRequest: @unchecked Sendable {}
extension Cosmos_Feegrant_V1beta1_QueryAllowanceResponse: @unchecked Sendable {}
extension Cosmos_Feegrant_V1beta1_QueryAllowancesRequest: @unchecked Sendable {}
extension Cosmos_Feegrant_V1beta1_QueryAllowancesResponse: @unchecked Sendable {}
extension Cosmos_Feegrant_V1beta1_QueryAllowancesByGranterRequest: @unchecked Sendable {}
extension Cosmos_Feegrant_V1beta1_QueryAllowancesByGranterResponse: @unchecked Sendable {}
