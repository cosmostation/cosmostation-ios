...
/// instant in time.
struct Kava_Incentive_V1beta1_Apy {
...
extension Kava_Incentive_V1beta1_Apy: @unchecked Sendable {}
...
extension Kava_Incentive_V1beta1_Apy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Apy"
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.apy) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.apy.isEmpty {
      try visitor.visitSingularStringField(value: self.apy, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Kava_Incentive_V1beta1_Apy, rhs: Kava_Incentive_V1beta1_Apy) -> Bool {
