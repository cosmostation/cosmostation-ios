...
extension Kava_Incentive_V1beta1_AccumulationTime: @unchecked Sendable {}
extension Kava_Incentive_V1beta1_GenesisRewardState: @unchecked Sendable {}
extension Kava_Incentive_V1beta1_GenesisState: @unchecked Sendable {}
...
extension Kava_Incentive_V1beta1_AccumulationTime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._previousAccumulationTime {
...
extension Kava_Incentive_V1beta1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._usdxRewardState {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      } }()
      try { if let v = _storage._hardSupplyRewardState {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      } }()
      try { if let v = _storage._hardBorrowRewardState {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
      } }()
      try { if let v = _storage._delegatorRewardState {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
      } }()
      try { if let v = _storage._swapRewardState {
      ...
      try { if let v = _storage._savingsRewardState {
      ...
      try { if let v = _storage._earnRewardState {
