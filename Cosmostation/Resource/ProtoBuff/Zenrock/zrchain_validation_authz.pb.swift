...
enum Zrchain_Validation_AuthorizationType: SwiftProtobuf.Enum {
...
extension Zrchain_Validation_AuthorizationType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Zrchain_Validation_AuthorizationType] = [
    .unspecified,
    .delegate,
    .undelegate,
    .redelegate,
...
///
/// Since: cosmos-sdk 0.43
struct Zrchain_Validation_StakeAuthorization {
  ...
  var validators: Zrchain_Validation_StakeAuthorization.OneOf_Validators? = nil

  /// allow_list specifies list of validator addresses to whom grantee can
  /// delegate tokens on behalf of granter's account.
  var allowList: Zrchain_Validation_StakeAuthorization.Validators {
    get {
      if case .allowList(let v)? = validators {return v}
      return Zrchain_Validation_StakeAuthorization.Validators()
    }
  ...
  /// delegate tokens.
  var denyList: Zrchain_Validation_StakeAuthorization.Validators {
    get {
  ...
  var authorizationType: Zrchain_Validation_AuthorizationType = .unspecified
  ...
  enum OneOf_Validators: Equatable {
    /// allow_list specifies list of validator addresses to whom grantee can
    /// delegate tokens on behalf of granter's account.
    case allowList(Zrchain_Validation_StakeAuthorization.Validators)
    /// deny_list specifies list of validator addresses to whom grantee can not
    /// delegate tokens.
    case denyList(Zrchain_Validation_StakeAuthorization.Validators)

  #if !swift(>=4.1)
    static func ==(lhs: Zrchain_Validation_StakeAuthorization.OneOf_Validators, rhs: Zrchain_Validation_StakeAuthorization.OneOf_Validators) -> Bool {
...
extension Zrchain_Validation_AuthorizationType: @unchecked Sendable {}
extension Zrchain_Validation_StakeAuthorization: @unchecked Sendable {}
extension Zrchain_Validation_StakeAuthorization.OneOf_Validators: @unchecked Sendable {}
extension Zrchain_Validation_StakeAuthorization.Validators: @unchecked Sendable {}
...
extension Zrchain_Validation_AuthorizationType: SwiftProtobuf._ProtoNameProviding {
...
extension Zrchain_Validation_StakeAuthorization: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Zrchain_Validation_StakeAuthorization.Validators?
  ...
  static func ==(lhs: Zrchain_Validation_StakeAuthorization, rhs: Zrchain_Validation_StakeAuthorization) -> Bool {
...
extension Zrchain_Validation_StakeAuthorization.Validators: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Zrchain_Validation_StakeAuthorization.protoMessageName + ".Validators"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Zrchain_Validation_StakeAuthorization.Validators, rhs: Zrchain_Validation_StakeAuthorization.Validators) -> Bool {
