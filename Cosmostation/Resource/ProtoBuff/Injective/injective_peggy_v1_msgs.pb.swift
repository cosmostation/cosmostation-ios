...
struct Injective_Peggy_V1_MsgUpdateParams {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Injective_Peggy_V1_MsgUpdateParamsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Injective_Peggy_V1_MsgSetOrchestratorAddresses: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgSetOrchestratorAddressesResponse: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgValsetConfirm: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgValsetConfirmResponse: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgSendToEth: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgSendToEthResponse: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgRequestBatch: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgRequestBatchResponse: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgConfirmBatch: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgConfirmBatchResponse: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgDepositClaim: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgDepositClaimResponse: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgWithdrawClaim: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgWithdrawClaimResponse: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgERC20DeployedClaim: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgERC20DeployedClaimResponse: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgCancelSendToEth: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgCancelSendToEthResponse: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgSubmitBadSignatureEvidence: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgSubmitBadSignatureEvidenceResponse: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgValsetUpdatedClaim: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgValsetUpdatedClaimResponse: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgUpdateParams: @unchecked Sendable {}
extension Injective_Peggy_V1_MsgUpdateParamsResponse: @unchecked Sendable {}
...
extension Injective_Peggy_V1_MsgDepositClaim: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 8: try { try decoder.decodeSingularStringField(value: &self.data) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.data.isEmpty {
      try visitor.visitSingularStringField(value: self.data, fieldNumber: 8)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Injective_Peggy_V1_MsgUpdateParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Injective_Peggy_V1_MsgUpdateParams, rhs: Injective_Peggy_V1_MsgUpdateParams) -> Bool {
...
extension Injective_Peggy_V1_MsgUpdateParamsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Injective_Peggy_V1_MsgUpdateParamsResponse, rhs: Injective_Peggy_V1_MsgUpdateParamsResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
