...
struct Injective_Insurance_V1beta1_EventUnderwrite {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// address of the underwriter
  var underwriter: String = String()
  ...
  /// share coin amount
  var shares: Cosmos_Base_V1beta1_Coin {
    get {return _shares ?? Cosmos_Base_V1beta1_Coin()}
  ...
  fileprivate var _shares: Cosmos_Base_V1beta1_Coin? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Injective_Insurance_V1beta1_Params: @unchecked Sendable {}
extension Injective_Insurance_V1beta1_InsuranceFund: @unchecked Sendable {}
extension Injective_Insurance_V1beta1_RedemptionSchedule: @unchecked Sendable {}
extension Injective_Insurance_V1beta1_EventInsuranceFundUpdate: @unchecked Sendable {}
extension Injective_Insurance_V1beta1_EventRequestRedemption: @unchecked Sendable {}
extension Injective_Insurance_V1beta1_EventWithdrawRedemption: @unchecked Sendable {}
extension Injective_Insurance_V1beta1_EventUnderwrite: @unchecked Sendable {}
...
extension Injective_Insurance_V1beta1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._defaultRedemptionNoticePeriodDuration {
...
extension Injective_Insurance_V1beta1_InsuranceFund: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._redemptionNoticePeriodDuration {
...
extension Injective_Insurance_V1beta1_RedemptionSchedule: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._claimableRedemptionTime {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    } }()
    try { if let v = self._redemptionAmount {
...
extension Injective_Insurance_V1beta1_EventUnderwrite: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EventUnderwrite"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "underwriter"),
    2: .same(proto: "marketId"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.underwriter) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.marketID) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._deposit) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._shares) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    if !self.underwriter.isEmpty {
      try visitor.visitSingularStringField(value: self.underwriter, fieldNumber: 1)
    }
    if !self.marketID.isEmpty {
      try visitor.visitSingularStringField(value: self.marketID, fieldNumber: 2)
    }
  ...
  static func ==(lhs: Injective_Insurance_V1beta1_EventUnderwrite, rhs: Injective_Insurance_V1beta1_EventUnderwrite) -> Bool {
    if lhs.underwriter != rhs.underwriter {return false}
    if lhs.marketID != rhs.marketID {return false}
