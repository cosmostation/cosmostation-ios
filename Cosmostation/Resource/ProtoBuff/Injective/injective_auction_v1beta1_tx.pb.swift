...
struct Injective_Auction_V1beta1_MsgUpdateParams {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Injective_Auction_V1beta1_MsgUpdateParamsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Injective_Auction_V1beta1_MsgBid: @unchecked Sendable {}
extension Injective_Auction_V1beta1_MsgBidResponse: @unchecked Sendable {}
extension Injective_Auction_V1beta1_MsgUpdateParams: @unchecked Sendable {}
extension Injective_Auction_V1beta1_MsgUpdateParamsResponse: @unchecked Sendable {}
...
extension Injective_Auction_V1beta1_MsgUpdateParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Injective_Auction_V1beta1_MsgUpdateParams, rhs: Injective_Auction_V1beta1_MsgUpdateParams) -> Bool {
...
extension Injective_Auction_V1beta1_MsgUpdateParamsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Injective_Auction_V1beta1_MsgUpdateParamsResponse, rhs: Injective_Auction_V1beta1_MsgUpdateParamsResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
