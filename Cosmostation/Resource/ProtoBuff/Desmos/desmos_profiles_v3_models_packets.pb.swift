...
extension Desmos_Profiles_V3_LinkChainAccountPacketData: @unchecked Sendable {}
extension Desmos_Profiles_V3_LinkChainAccountPacketAck: @unchecked Sendable {}
...
extension Desmos_Profiles_V3_LinkChainAccountPacketData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._sourceAddress {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try { if let v = self._sourceProof {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    } }()
    try { if let v = self._sourceChainConfig {
    ...
    try { if let v = self._destinationProof {
