...
/// command
struct Desmos_Profiles_V3_Client_ChainLinkJSON {
...
extension Desmos_Profiles_V3_Client_ChainLinkJSON: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "desmos.profiles.v3.client"

extension Desmos_Profiles_V3_Client_ChainLinkJSON: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V3_Client_ChainLinkJSON, rhs: Desmos_Profiles_V3_Client_ChainLinkJSON) -> Bool {
