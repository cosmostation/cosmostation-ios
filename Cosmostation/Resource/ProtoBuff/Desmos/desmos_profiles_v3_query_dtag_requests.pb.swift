...
struct Desmos_Profiles_V3_QueryIncomingDTagTransferRequestsRequest {
...
struct Desmos_Profiles_V3_QueryIncomingDTagTransferRequestsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// the user
  var requests: [Desmos_Profiles_V3_DTagTransferRequest] = []
...
extension Desmos_Profiles_V3_QueryIncomingDTagTransferRequestsRequest: @unchecked Sendable {}
extension Desmos_Profiles_V3_QueryIncomingDTagTransferRequestsResponse: @unchecked Sendable {}
...
extension Desmos_Profiles_V3_QueryIncomingDTagTransferRequestsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V3_QueryIncomingDTagTransferRequestsRequest, rhs: Desmos_Profiles_V3_QueryIncomingDTagTransferRequestsRequest) -> Bool {
...
extension Desmos_Profiles_V3_QueryIncomingDTagTransferRequestsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V3_QueryIncomingDTagTransferRequestsResponse, rhs: Desmos_Profiles_V3_QueryIncomingDTagTransferRequestsResponse) -> Bool {
