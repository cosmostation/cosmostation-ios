...
/// single user
struct Desmos_Profiles_V2_Profile {
  ...
  var pictures: Desmos_Profiles_V2_Pictures {
    get {return _pictures ?? Desmos_Profiles_V2_Pictures()}
  ...
  fileprivate var _pictures: Desmos_Profiles_V2_Pictures? = nil
  fileprivate var _creationDate: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
}

/// Pictures contains the data of a user profile's related pictures
struct Desmos_Profiles_V2_Pictures {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Desmos_Profiles_V2_Profile: @unchecked Sendable {}
extension Desmos_Profiles_V2_Pictures: @unchecked Sendable {}
...
extension Desmos_Profiles_V2_Profile: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V2_Profile, rhs: Desmos_Profiles_V2_Profile) -> Bool {
...
extension Desmos_Profiles_V2_Pictures: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V2_Pictures, rhs: Desmos_Profiles_V2_Pictures) -> Bool {
