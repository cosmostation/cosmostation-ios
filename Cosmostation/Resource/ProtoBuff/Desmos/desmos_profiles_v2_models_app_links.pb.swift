...
enum Desmos_Profiles_V2_ApplicationLinkState: SwiftProtobuf.Enum {
...
extension Desmos_Profiles_V2_ApplicationLinkState: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Desmos_Profiles_V2_ApplicationLinkState] = [
...
struct Desmos_Profiles_V2_ApplicationLink {
  ...
  var data: Desmos_Profiles_V2_Data {
    get {return _data ?? Desmos_Profiles_V2_Data()}
    set {_data = newValue}
  }
  ...
  /// State of the link
  var state: Desmos_Profiles_V2_ApplicationLinkState = .initializedUnspecified

  /// OracleRequest represents the request that has been made to the oracle
  var oracleRequest: Desmos_Profiles_V2_OracleRequest {
    get {return _oracleRequest ?? Desmos_Profiles_V2_OracleRequest()}
  ...
  var result: Desmos_Profiles_V2_Result {
    get {return _result ?? Desmos_Profiles_V2_Result()}
  ...
  fileprivate var _data: Desmos_Profiles_V2_Data? = nil
  fileprivate var _oracleRequest: Desmos_Profiles_V2_OracleRequest? = nil
  fileprivate var _result: Desmos_Profiles_V2_Result? = nil
...
struct Desmos_Profiles_V2_Data {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Desmos_Profiles_V2_OracleRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var callData: Desmos_Profiles_V2_OracleRequest.CallData {
    get {return _callData ?? Desmos_Profiles_V2_OracleRequest.CallData()}
  ...
  fileprivate var _callData: Desmos_Profiles_V2_OracleRequest.CallData? = nil
}

/// Result represents a verification result
struct Desmos_Profiles_V2_Result {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// failure result
  var sum: Desmos_Profiles_V2_Result.OneOf_Sum? = nil

  /// Success represents a successful verification
  var success: Desmos_Profiles_V2_Result.Success {
    get {
      if case .success(let v)? = sum {return v}
      return Desmos_Profiles_V2_Result.Success()
    }
    set {sum = .success(newValue)}
  }

  /// Failed represents a failed verification
  var failed: Desmos_Profiles_V2_Result.Failed {
    get {
      if case .failed(let v)? = sum {return v}
      return Desmos_Profiles_V2_Result.Failed()
    }
  ...
  enum OneOf_Sum: Equatable {
    /// Success represents a successful verification
    case success(Desmos_Profiles_V2_Result.Success)
    /// Failed represents a failed verification
    case failed(Desmos_Profiles_V2_Result.Failed)

  #if !swift(>=4.1)
    static func ==(lhs: Desmos_Profiles_V2_Result.OneOf_Sum, rhs: Desmos_Profiles_V2_Result.OneOf_Sum) -> Bool {
...
extension Desmos_Profiles_V2_ApplicationLinkState: @unchecked Sendable {}
extension Desmos_Profiles_V2_ApplicationLink: @unchecked Sendable {}
extension Desmos_Profiles_V2_Data: @unchecked Sendable {}
extension Desmos_Profiles_V2_OracleRequest: @unchecked Sendable {}
extension Desmos_Profiles_V2_OracleRequest.CallData: @unchecked Sendable {}
extension Desmos_Profiles_V2_Result: @unchecked Sendable {}
extension Desmos_Profiles_V2_Result.OneOf_Sum: @unchecked Sendable {}
extension Desmos_Profiles_V2_Result.Success: @unchecked Sendable {}
extension Desmos_Profiles_V2_Result.Failed: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "desmos.profiles.v2"

extension Desmos_Profiles_V2_ApplicationLinkState: SwiftProtobuf._ProtoNameProviding {
...
extension Desmos_Profiles_V2_ApplicationLink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V2_ApplicationLink, rhs: Desmos_Profiles_V2_ApplicationLink) -> Bool {
...
extension Desmos_Profiles_V2_Data: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V2_Data, rhs: Desmos_Profiles_V2_Data) -> Bool {
...
extension Desmos_Profiles_V2_OracleRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V2_OracleRequest, rhs: Desmos_Profiles_V2_OracleRequest) -> Bool {
...
extension Desmos_Profiles_V2_OracleRequest.CallData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Desmos_Profiles_V2_OracleRequest.protoMessageName + ".CallData"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "application"),
  ...
  static func ==(lhs: Desmos_Profiles_V2_OracleRequest.CallData, rhs: Desmos_Profiles_V2_OracleRequest.CallData) -> Bool {
    if lhs.application != rhs.application {return false}
...
extension Desmos_Profiles_V2_Result: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Desmos_Profiles_V2_Result.Success?
      ...
      case 2: try {
        var v: Desmos_Profiles_V2_Result.Failed?
        var hadOneofValue = false
        if let current = self.sum {
          hadOneofValue = true
  ...
  static func ==(lhs: Desmos_Profiles_V2_Result, rhs: Desmos_Profiles_V2_Result) -> Bool {
...
extension Desmos_Profiles_V2_Result.Success: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Desmos_Profiles_V2_Result.protoMessageName + ".Success"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "value"),
  ...
  static func ==(lhs: Desmos_Profiles_V2_Result.Success, rhs: Desmos_Profiles_V2_Result.Success) -> Bool {
...
extension Desmos_Profiles_V2_Result.Failed: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Desmos_Profiles_V2_Result.protoMessageName + ".Failed"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "error"),
  ]
  ...
  static func ==(lhs: Desmos_Profiles_V2_Result.Failed, rhs: Desmos_Profiles_V2_Result.Failed) -> Bool {
