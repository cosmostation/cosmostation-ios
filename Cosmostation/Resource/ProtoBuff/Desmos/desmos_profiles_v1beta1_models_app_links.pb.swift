...
enum Desmos_Profiles_V1beta1_ApplicationLinkState: SwiftProtobuf.Enum {
...
extension Desmos_Profiles_V1beta1_ApplicationLinkState: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Desmos_Profiles_V1beta1_ApplicationLinkState] = [
...
struct Desmos_Profiles_V1beta1_ApplicationLink {
  ...
  var data: Desmos_Profiles_V1beta1_Data {
    get {return _data ?? Desmos_Profiles_V1beta1_Data()}
    set {_data = newValue}
  }
  ...
  /// State of the link
  var state: Desmos_Profiles_V1beta1_ApplicationLinkState = .initializedUnspecified

  /// OracleRequest represents the request that has been made to the oracle
  var oracleRequest: Desmos_Profiles_V1beta1_OracleRequest {
    get {return _oracleRequest ?? Desmos_Profiles_V1beta1_OracleRequest()}
  ...
  var result: Desmos_Profiles_V1beta1_Result {
    get {return _result ?? Desmos_Profiles_V1beta1_Result()}
  ...
  fileprivate var _data: Desmos_Profiles_V1beta1_Data? = nil
  fileprivate var _oracleRequest: Desmos_Profiles_V1beta1_OracleRequest? = nil
  fileprivate var _result: Desmos_Profiles_V1beta1_Result? = nil
...
struct Desmos_Profiles_V1beta1_Data {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Desmos_Profiles_V1beta1_OracleRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var callData: Desmos_Profiles_V1beta1_OracleRequest.CallData {
    get {return _callData ?? Desmos_Profiles_V1beta1_OracleRequest.CallData()}
  ...
  fileprivate var _callData: Desmos_Profiles_V1beta1_OracleRequest.CallData? = nil
}

/// Result represents a verification result
struct Desmos_Profiles_V1beta1_Result {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// failure result
  var sum: Desmos_Profiles_V1beta1_Result.OneOf_Sum? = nil

  /// Success represents a successful verification
  var success: Desmos_Profiles_V1beta1_Result.Success {
    get {
      if case .success(let v)? = sum {return v}
      return Desmos_Profiles_V1beta1_Result.Success()
    }
    set {sum = .success(newValue)}
  }

  /// Failed represents a failed verification
  var failed: Desmos_Profiles_V1beta1_Result.Failed {
    get {
      if case .failed(let v)? = sum {return v}
      return Desmos_Profiles_V1beta1_Result.Failed()
    }
  ...
  enum OneOf_Sum: Equatable {
    /// Success represents a successful verification
    case success(Desmos_Profiles_V1beta1_Result.Success)
    /// Failed represents a failed verification
    case failed(Desmos_Profiles_V1beta1_Result.Failed)

  #if !swift(>=4.1)
    static func ==(lhs: Desmos_Profiles_V1beta1_Result.OneOf_Sum, rhs: Desmos_Profiles_V1beta1_Result.OneOf_Sum) -> Bool {
...
extension Desmos_Profiles_V1beta1_ApplicationLinkState: @unchecked Sendable {}
extension Desmos_Profiles_V1beta1_ApplicationLink: @unchecked Sendable {}
extension Desmos_Profiles_V1beta1_Data: @unchecked Sendable {}
extension Desmos_Profiles_V1beta1_OracleRequest: @unchecked Sendable {}
extension Desmos_Profiles_V1beta1_OracleRequest.CallData: @unchecked Sendable {}
extension Desmos_Profiles_V1beta1_Result: @unchecked Sendable {}
extension Desmos_Profiles_V1beta1_Result.OneOf_Sum: @unchecked Sendable {}
extension Desmos_Profiles_V1beta1_Result.Success: @unchecked Sendable {}
extension Desmos_Profiles_V1beta1_Result.Failed: @unchecked Sendable {}
...
extension Desmos_Profiles_V1beta1_ApplicationLinkState: SwiftProtobuf._ProtoNameProviding {
...
extension Desmos_Profiles_V1beta1_ApplicationLink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._oracleRequest {
  ...
  static func ==(lhs: Desmos_Profiles_V1beta1_ApplicationLink, rhs: Desmos_Profiles_V1beta1_ApplicationLink) -> Bool {
...
extension Desmos_Profiles_V1beta1_Data: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V1beta1_Data, rhs: Desmos_Profiles_V1beta1_Data) -> Bool {
...
extension Desmos_Profiles_V1beta1_OracleRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V1beta1_OracleRequest, rhs: Desmos_Profiles_V1beta1_OracleRequest) -> Bool {
...
extension Desmos_Profiles_V1beta1_OracleRequest.CallData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Desmos_Profiles_V1beta1_OracleRequest.protoMessageName + ".CallData"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "application"),
  ...
  static func ==(lhs: Desmos_Profiles_V1beta1_OracleRequest.CallData, rhs: Desmos_Profiles_V1beta1_OracleRequest.CallData) -> Bool {
    if lhs.application != rhs.application {return false}
...
extension Desmos_Profiles_V1beta1_Result: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Desmos_Profiles_V1beta1_Result.Success?
      ...
      case 2: try {
        var v: Desmos_Profiles_V1beta1_Result.Failed?
        var hadOneofValue = false
        if let current = self.sum {
          hadOneofValue = true
  ...
  static func ==(lhs: Desmos_Profiles_V1beta1_Result, rhs: Desmos_Profiles_V1beta1_Result) -> Bool {
...
extension Desmos_Profiles_V1beta1_Result.Success: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Desmos_Profiles_V1beta1_Result.protoMessageName + ".Success"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "value"),
  ...
  static func ==(lhs: Desmos_Profiles_V1beta1_Result.Success, rhs: Desmos_Profiles_V1beta1_Result.Success) -> Bool {
...
extension Desmos_Profiles_V1beta1_Result.Failed: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Desmos_Profiles_V1beta1_Result.protoMessageName + ".Failed"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "error"),
  ]
  ...
  static func ==(lhs: Desmos_Profiles_V1beta1_Result.Failed, rhs: Desmos_Profiles_V1beta1_Result.Failed) -> Bool {
