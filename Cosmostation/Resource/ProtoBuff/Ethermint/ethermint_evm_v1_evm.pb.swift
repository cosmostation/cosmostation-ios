...
extension Ethermint_Evm_V1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    7: .standard(proto: "active_precompiles"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeRepeatedStringField(value: &self.activePrecompiles) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.activePrecompiles.isEmpty {
      try visitor.visitRepeatedStringField(value: self.activePrecompiles, fieldNumber: 7)
    }
  ...
  static func ==(lhs: Ethermint_Evm_V1_Params, rhs: Ethermint_Evm_V1_Params) -> Bool {
    ...
    if lhs.activePrecompiles != rhs.activePrecompiles {return false}
