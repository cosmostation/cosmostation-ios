...
struct Injective_Types_V1beta1_ExtensionOptionsWeb3Tx {
...
extension Injective_Types_V1beta1_ExtensionOptionsWeb3Tx: @unchecked Sendable {}
...
extension Injective_Types_V1beta1_ExtensionOptionsWeb3Tx: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ExtensionOptionsWeb3Tx"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "typedDataChainID"),
    2: .same(proto: "feePayer"),
    3: .same(proto: "feePayerSig"),
  ]
  ...
  static func ==(lhs: Injective_Types_V1beta1_ExtensionOptionsWeb3Tx, rhs: Injective_Types_V1beta1_ExtensionOptionsWeb3Tx) -> Bool {
