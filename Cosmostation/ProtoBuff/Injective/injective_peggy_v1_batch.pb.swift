...
struct Injective_Peggy_V1_OutgoingTxBatch {
  ...
  var transactions: [Injective_Peggy_V1_OutgoingTransferTx] = []
...
struct Injective_Peggy_V1_OutgoingTransferTx {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var erc20Token: Injective_Peggy_V1_ERC20Token {
    get {return _erc20Token ?? Injective_Peggy_V1_ERC20Token()}
  ...
  var erc20Fee: Injective_Peggy_V1_ERC20Token {
    get {return _erc20Fee ?? Injective_Peggy_V1_ERC20Token()}
  ...
  fileprivate var _erc20Token: Injective_Peggy_V1_ERC20Token? = nil
  fileprivate var _erc20Fee: Injective_Peggy_V1_ERC20Token? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension Injective_Peggy_V1_OutgoingTxBatch: @unchecked Sendable {}
extension Injective_Peggy_V1_OutgoingTransferTx: @unchecked Sendable {}
...
extension Injective_Peggy_V1_OutgoingTxBatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Injective_Peggy_V1_OutgoingTxBatch, rhs: Injective_Peggy_V1_OutgoingTxBatch) -> Bool {
...
extension Injective_Peggy_V1_OutgoingTransferTx: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Injective_Peggy_V1_OutgoingTransferTx, rhs: Injective_Peggy_V1_OutgoingTransferTx) -> Bool {
