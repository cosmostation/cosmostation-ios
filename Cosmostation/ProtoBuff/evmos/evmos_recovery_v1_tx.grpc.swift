...
internal protocol Evmos_Recovery_V1_MsgClientProtocol: GRPCClient {
...
internal final class Evmos_Recovery_V1_MsgClient: Evmos_Recovery_V1_MsgClientProtocol {
  ...
  internal var interceptors: Evmos_Recovery_V1_MsgClientInterceptorFactoryProtocol? {
...
internal struct Evmos_Recovery_V1_MsgNIOClient: Evmos_Recovery_V1_MsgClientProtocol {
...
internal protocol Evmos_Recovery_V1_MsgAsyncClientProtocol: GRPCClient {
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal struct Evmos_Recovery_V1_MsgAsyncClient: Evmos_Recovery_V1_MsgAsyncClientProtocol {
  internal var channel: GRPCChannel
  internal var defaultCallOptions: CallOptions
  internal var interceptors: Evmos_Recovery_V1_MsgClientInterceptorFactoryProtocol?
...
internal protocol Evmos_Recovery_V1_MsgClientInterceptorFactoryProtocol: Sendable {
...
internal enum Evmos_Recovery_V1_MsgClientMetadata {
...
internal protocol Evmos_Recovery_V1_MsgProvider: CallHandlerProvider {
  var interceptors: Evmos_Recovery_V1_MsgServerInterceptorFactoryProtocol? { get }

  /// UpdateParams defined a governance operation for updating the x/recovery module parameters.
  /// The authority is hard-coded to the Cosmos SDK x/gov module account.
  func updateParams(request: Evmos_Recovery_V1_MsgUpdateParams, context: StatusOnlyCallContext) -> EventLoopFuture<Evmos_Recovery_V1_MsgUpdateParamsResponse>
}

extension Evmos_Recovery_V1_MsgProvider {
  internal var serviceName: Substring {
    return Evmos_Recovery_V1_MsgServerMetadata.serviceDescriptor.fullName[...]
  }
  ...
  internal func handle(
    ...
    case "UpdateParams":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Evmos_Recovery_V1_MsgUpdateParams>(),
        responseSerializer: ProtobufSerializer<Evmos_Recovery_V1_MsgUpdateParamsResponse>(),
        interceptors: self.interceptors?.makeUpdateParamsInterceptors() ?? [],
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Evmos_Recovery_V1_MsgAsyncProvider: CallHandlerProvider {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Evmos_Recovery_V1_MsgServerInterceptorFactoryProtocol? { get }
  ...
  @Sendable func updateParams(
    request: Evmos_Recovery_V1_MsgUpdateParams,
    context: GRPCAsyncServerCallContext
  ) async throws -> Evmos_Recovery_V1_MsgUpdateParamsResponse
}

@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
extension Evmos_Recovery_V1_MsgAsyncProvider {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Evmos_Recovery_V1_MsgServerMetadata.serviceDescriptor
  }
  ...
  internal var interceptors: Evmos_Recovery_V1_MsgServerInterceptorFactoryProtocol? {
    return nil
  }
...
internal protocol Evmos_Recovery_V1_MsgServerInterceptorFactoryProtocol {

  /// - Returns: Interceptors to use when handling 'updateParams'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeUpdateParamsInterceptors() -> [ServerInterceptor<Evmos_Recovery_V1_MsgUpdateParams, Evmos_Recovery_V1_MsgUpdateParamsResponse>]
}

internal enum Evmos_Recovery_V1_MsgServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "Msg",
    fullName: "evmos.recovery.v1.Msg",
    methods: [
      Evmos_Recovery_V1_MsgServerMetadata.Methods.updateParams,
    ]
  )
