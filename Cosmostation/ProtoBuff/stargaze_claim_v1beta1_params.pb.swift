...
extension Publicawesome_Stargaze_Claim_V1beta1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularBoolField(value: &self.airdropEnabled)
      case 2: try decoder.decodeSingularMessageField(value: &self._airdropStartTime)
      case 3: try decoder.decodeSingularMessageField(value: &self._durationUntilDecay)
      case 4: try decoder.decodeSingularMessageField(value: &self._durationOfDecay)
      case 5: try decoder.decodeSingularStringField(value: &self.claimDenom)
      case 6: try decoder.decodeRepeatedMessageField(value: &self.allowedClaimers)
      default: break
      }
    }
  }
