...
struct Starnamed_X_Escrow_V1beta1_Escrow {
  ...
  var state: Starnamed_X_Escrow_V1beta1_EscrowState = .openUnspecified
...
extension Starnamed_X_Escrow_V1beta1_EscrowState: @unchecked Sendable {}
extension Starnamed_X_Escrow_V1beta1_Escrow: @unchecked Sendable {}
...
extension Starnamed_X_Escrow_V1beta1_EscrowState: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "ESCROW_STATE_OPEN_UNSPECIFIED"),
