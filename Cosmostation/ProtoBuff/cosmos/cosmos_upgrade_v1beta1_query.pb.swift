...
struct Cosmos_Upgrade_V1beta1_QueryAuthorityRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///
/// Since: cosmos-sdk 0.46
struct Cosmos_Upgrade_V1beta1_QueryAuthorityResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cosmos_Upgrade_V1beta1_QueryCurrentPlanRequest: @unchecked Sendable {}
extension Cosmos_Upgrade_V1beta1_QueryCurrentPlanResponse: @unchecked Sendable {}
extension Cosmos_Upgrade_V1beta1_QueryAppliedPlanRequest: @unchecked Sendable {}
extension Cosmos_Upgrade_V1beta1_QueryAppliedPlanResponse: @unchecked Sendable {}
extension Cosmos_Upgrade_V1beta1_QueryUpgradedConsensusStateRequest: @unchecked Sendable {}
extension Cosmos_Upgrade_V1beta1_QueryUpgradedConsensusStateResponse: @unchecked Sendable {}
extension Cosmos_Upgrade_V1beta1_QueryModuleVersionsRequest: @unchecked Sendable {}
extension Cosmos_Upgrade_V1beta1_QueryModuleVersionsResponse: @unchecked Sendable {}
extension Cosmos_Upgrade_V1beta1_QueryAuthorityRequest: @unchecked Sendable {}
extension Cosmos_Upgrade_V1beta1_QueryAuthorityResponse: @unchecked Sendable {}
