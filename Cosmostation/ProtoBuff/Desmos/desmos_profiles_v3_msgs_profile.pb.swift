...
struct Desmos_Profiles_V3_MsgSaveProfile {
...
struct Desmos_Profiles_V3_MsgSaveProfileResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Desmos_Profiles_V3_MsgDeleteProfile {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Desmos_Profiles_V3_MsgDeleteProfileResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Desmos_Profiles_V3_MsgSaveProfile: @unchecked Sendable {}
extension Desmos_Profiles_V3_MsgSaveProfileResponse: @unchecked Sendable {}
extension Desmos_Profiles_V3_MsgDeleteProfile: @unchecked Sendable {}
extension Desmos_Profiles_V3_MsgDeleteProfileResponse: @unchecked Sendable {}
...
extension Desmos_Profiles_V3_MsgSaveProfile: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V3_MsgSaveProfile, rhs: Desmos_Profiles_V3_MsgSaveProfile) -> Bool {
...
extension Desmos_Profiles_V3_MsgSaveProfileResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V3_MsgSaveProfileResponse, rhs: Desmos_Profiles_V3_MsgSaveProfileResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Desmos_Profiles_V3_MsgDeleteProfile: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V3_MsgDeleteProfile, rhs: Desmos_Profiles_V3_MsgDeleteProfile) -> Bool {
    if lhs.creator != rhs.creator {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Desmos_Profiles_V3_MsgDeleteProfileResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Profiles_V3_MsgDeleteProfileResponse, rhs: Desmos_Profiles_V3_MsgDeleteProfileResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
