...
struct Crescent_Mint_V1beta1_Params {
  ...
  var mintPoolAddress: String = String()
...
extension Crescent_Mint_V1beta1_Params: @unchecked Sendable {}
extension Crescent_Mint_V1beta1_InflationSchedule: @unchecked Sendable {}
...
extension Crescent_Mint_V1beta1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "mint_pool_address"),
    3: .standard(proto: "block_time_threshold"),
    4: .standard(proto: "inflation_schedules"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.mintPoolAddress) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._blockTimeThreshold) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.inflationSchedules) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.mintPoolAddress.isEmpty {
      try visitor.visitSingularStringField(value: self.mintPoolAddress, fieldNumber: 2)
    }
    try { if let v = self._blockTimeThreshold {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    } }()
    if !self.inflationSchedules.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.inflationSchedules, fieldNumber: 4)
    }
  ...
  static func ==(lhs: Crescent_Mint_V1beta1_Params, rhs: Crescent_Mint_V1beta1_Params) -> Bool {
    ...
    if lhs.mintPoolAddress != rhs.mintPoolAddress {return false}
