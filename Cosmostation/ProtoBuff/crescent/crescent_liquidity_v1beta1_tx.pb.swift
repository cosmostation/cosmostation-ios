...
struct Crescent_Liquidity_V1beta1_MsgCreateRangedPool {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Crescent_Liquidity_V1beta1_MsgCreateRangedPoolResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Crescent_Liquidity_V1beta1_MsgMMOrder {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Crescent_Liquidity_V1beta1_MsgMMOrderResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Crescent_Liquidity_V1beta1_MsgCreatePair: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgCreatePairResponse: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgCreatePool: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgCreatePoolResponse: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgCreateRangedPool: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgCreateRangedPoolResponse: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgDeposit: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgDepositResponse: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgWithdraw: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgWithdrawResponse: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgLimitOrder: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgLimitOrderResponse: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgMarketOrder: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgMarketOrderResponse: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgMMOrder: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgMMOrderResponse: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgCancelOrder: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgCancelOrderResponse: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgCancelAllOrders: @unchecked Sendable {}
extension Crescent_Liquidity_V1beta1_MsgCancelAllOrdersResponse: @unchecked Sendable {}
...
extension Crescent_Liquidity_V1beta1_MsgCreateRangedPool: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .standard(proto: "initial_price"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularUInt64Field(value: &self.pairID) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.depositCoins) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.minPrice) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.maxPrice) }()
      case 6: try { try decoder.decodeSingularStringField(value: &self.initialPrice) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.minPrice.isEmpty {
      try visitor.visitSingularStringField(value: self.minPrice, fieldNumber: 4)
    }
    if !self.maxPrice.isEmpty {
      try visitor.visitSingularStringField(value: self.maxPrice, fieldNumber: 5)
    }
    if !self.initialPrice.isEmpty {
      try visitor.visitSingularStringField(value: self.initialPrice, fieldNumber: 6)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Crescent_Liquidity_V1beta1_MsgCreateRangedPool, rhs: Crescent_Liquidity_V1beta1_MsgCreateRangedPool) -> Bool {
    if lhs.creator != rhs.creator {return false}
    if lhs.pairID != rhs.pairID {return false}
    if lhs.depositCoins != rhs.depositCoins {return false}
...
extension Crescent_Liquidity_V1beta1_MsgCreateRangedPoolResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Crescent_Liquidity_V1beta1_MsgCreateRangedPoolResponse, rhs: Crescent_Liquidity_V1beta1_MsgCreateRangedPoolResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Crescent_Liquidity_V1beta1_MsgMMOrder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Crescent_Liquidity_V1beta1_MsgMMOrder, rhs: Crescent_Liquidity_V1beta1_MsgMMOrder) -> Bool {
    if lhs.orderer != rhs.orderer {return false}
    if lhs.pairID != rhs.pairID {return false}
    if lhs.direction != rhs.direction {return false}
    if lhs._offerCoin != rhs._offerCoin {return false}
...
extension Crescent_Liquidity_V1beta1_MsgMMOrderResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Crescent_Liquidity_V1beta1_MsgMMOrderResponse, rhs: Crescent_Liquidity_V1beta1_MsgMMOrderResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
