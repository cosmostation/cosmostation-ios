...
struct Kava_Committee_V1beta1_BaseCommittee {
  ...
  var permissions: [SwiftProtobuf.Google_Protobuf_Any] = []
...
extension Kava_Committee_V1beta1_TallyOption: @unchecked Sendable {}
extension Kava_Committee_V1beta1_BaseCommittee: @unchecked Sendable {}
extension Kava_Committee_V1beta1_MemberCommittee: @unchecked Sendable {}
extension Kava_Committee_V1beta1_TokenCommittee: @unchecked Sendable {}
...
extension Kava_Committee_V1beta1_BaseCommittee: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._proposalDuration {
...
extension Kava_Committee_V1beta1_MemberCommittee: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._baseCommittee {
