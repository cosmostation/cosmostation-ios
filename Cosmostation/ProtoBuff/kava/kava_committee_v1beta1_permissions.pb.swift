...
struct Kava_Committee_V1beta1_CommunityCDPRepayDebtPermission {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Kava_Committee_V1beta1_CommunityCDPWithdrawCollateralPermission {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Kava_Committee_V1beta1_CommunityPoolLendWithdrawPermission {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Kava_Committee_V1beta1_GodPermission: @unchecked Sendable {}
extension Kava_Committee_V1beta1_SoftwareUpgradePermission: @unchecked Sendable {}
extension Kava_Committee_V1beta1_TextPermission: @unchecked Sendable {}
extension Kava_Committee_V1beta1_CommunityCDPRepayDebtPermission: @unchecked Sendable {}
extension Kava_Committee_V1beta1_CommunityCDPWithdrawCollateralPermission: @unchecked Sendable {}
extension Kava_Committee_V1beta1_CommunityPoolLendWithdrawPermission: @unchecked Sendable {}
extension Kava_Committee_V1beta1_ParamsChangePermission: @unchecked Sendable {}
extension Kava_Committee_V1beta1_AllowedParamsChange: @unchecked Sendable {}
extension Kava_Committee_V1beta1_SubparamRequirement: @unchecked Sendable {}
...
extension Kava_Committee_V1beta1_CommunityCDPRepayDebtPermission: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CommunityCDPRepayDebtPermission"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Kava_Committee_V1beta1_CommunityCDPRepayDebtPermission, rhs: Kava_Committee_V1beta1_CommunityCDPRepayDebtPermission) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Kava_Committee_V1beta1_CommunityCDPWithdrawCollateralPermission: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CommunityCDPWithdrawCollateralPermission"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Kava_Committee_V1beta1_CommunityCDPWithdrawCollateralPermission, rhs: Kava_Committee_V1beta1_CommunityCDPWithdrawCollateralPermission) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Kava_Committee_V1beta1_CommunityPoolLendWithdrawPermission: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CommunityPoolLendWithdrawPermission"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Kava_Committee_V1beta1_CommunityPoolLendWithdrawPermission, rhs: Kava_Committee_V1beta1_CommunityPoolLendWithdrawPermission) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
