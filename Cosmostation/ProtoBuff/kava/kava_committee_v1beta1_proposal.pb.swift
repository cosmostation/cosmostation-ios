...
struct Kava_Committee_V1beta1_CommitteeChangeProposal {
  ...
  var newCommittee: SwiftProtobuf.Google_Protobuf_Any {
    get {return _newCommittee ?? SwiftProtobuf.Google_Protobuf_Any()}
  ...
  fileprivate var _newCommittee: SwiftProtobuf.Google_Protobuf_Any? = nil
}
...
extension Kava_Committee_V1beta1_CommitteeChangeProposal: @unchecked Sendable {}
extension Kava_Committee_V1beta1_CommitteeDeleteProposal: @unchecked Sendable {}
...
extension Kava_Committee_V1beta1_CommitteeChangeProposal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._newCommittee {
