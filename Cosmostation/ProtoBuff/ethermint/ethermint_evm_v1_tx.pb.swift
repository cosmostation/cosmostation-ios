...
struct Ethermint_Evm_V1_MsgUpdateParams {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Ethermint_Evm_V1_MsgUpdateParamsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Ethermint_Evm_V1_MsgEthereumTx: @unchecked Sendable {}
extension Ethermint_Evm_V1_LegacyTx: @unchecked Sendable {}
extension Ethermint_Evm_V1_AccessListTx: @unchecked Sendable {}
extension Ethermint_Evm_V1_DynamicFeeTx: @unchecked Sendable {}
extension Ethermint_Evm_V1_ExtensionOptionsEthereumTx: @unchecked Sendable {}
extension Ethermint_Evm_V1_MsgEthereumTxResponse: @unchecked Sendable {}
extension Ethermint_Evm_V1_MsgUpdateParams: @unchecked Sendable {}
extension Ethermint_Evm_V1_MsgUpdateParamsResponse: @unchecked Sendable {}
...
extension Ethermint_Evm_V1_MsgUpdateParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Ethermint_Evm_V1_MsgUpdateParams, rhs: Ethermint_Evm_V1_MsgUpdateParams) -> Bool {
...
extension Ethermint_Evm_V1_MsgUpdateParamsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Ethermint_Evm_V1_MsgUpdateParamsResponse, rhs: Ethermint_Evm_V1_MsgUpdateParamsResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
