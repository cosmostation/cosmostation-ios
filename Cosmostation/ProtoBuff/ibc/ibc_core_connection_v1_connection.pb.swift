...
struct Ibc_Core_Connection_V1_Params {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Ibc_Core_Connection_V1_State: @unchecked Sendable {}
extension Ibc_Core_Connection_V1_ConnectionEnd: @unchecked Sendable {}
extension Ibc_Core_Connection_V1_IdentifiedConnection: @unchecked Sendable {}
extension Ibc_Core_Connection_V1_Counterparty: @unchecked Sendable {}
extension Ibc_Core_Connection_V1_ClientPaths: @unchecked Sendable {}
extension Ibc_Core_Connection_V1_ConnectionPaths: @unchecked Sendable {}
extension Ibc_Core_Connection_V1_Version: @unchecked Sendable {}
extension Ibc_Core_Connection_V1_Params: @unchecked Sendable {}
