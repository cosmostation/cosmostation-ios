...
struct Bitsong_Nft_V1beta1_GenesisState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var collections: [Bitsong_Nft_V1beta1_Collection] = []
...
extension Bitsong_Nft_V1beta1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Bitsong_Nft_V1beta1_GenesisState, rhs: Bitsong_Nft_V1beta1_GenesisState) -> Bool {
