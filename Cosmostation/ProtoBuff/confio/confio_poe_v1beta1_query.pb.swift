...
struct Confio_Poe_V1beta1_QueryValidatorEngagementRewardRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Query/ValidatorEngagementReward RPC method.
struct Confio_Poe_V1beta1_QueryValidatorEngagementRewardResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Confio_Poe_V1beta1_QueryContractAddressRequest: @unchecked Sendable {}
extension Confio_Poe_V1beta1_QueryContractAddressResponse: @unchecked Sendable {}
extension Confio_Poe_V1beta1_QueryUnbondingPeriodRequest: @unchecked Sendable {}
extension Confio_Poe_V1beta1_QueryUnbondingPeriodResponse: @unchecked Sendable {}
extension Confio_Poe_V1beta1_QueryValidatorDelegationRequest: @unchecked Sendable {}
extension Confio_Poe_V1beta1_QueryValidatorDelegationResponse: @unchecked Sendable {}
extension Confio_Poe_V1beta1_QueryValidatorUnbondingDelegationsRequest: @unchecked Sendable {}
extension Confio_Poe_V1beta1_QueryValidatorUnbondingDelegationsResponse: @unchecked Sendable {}
extension Confio_Poe_V1beta1_QueryValidatorOutstandingRewardRequest: @unchecked Sendable {}
extension Confio_Poe_V1beta1_QueryValidatorOutstandingRewardResponse: @unchecked Sendable {}
extension Confio_Poe_V1beta1_QueryValidatorEngagementRewardRequest: @unchecked Sendable {}
extension Confio_Poe_V1beta1_QueryValidatorEngagementRewardResponse: @unchecked Sendable {}
...
extension Confio_Poe_V1beta1_QueryValidatorEngagementRewardRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QueryValidatorEngagementRewardRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "validator_address"),
  ]
  ...
  static func ==(lhs: Confio_Poe_V1beta1_QueryValidatorEngagementRewardRequest, rhs: Confio_Poe_V1beta1_QueryValidatorEngagementRewardRequest) -> Bool {
    if lhs.validatorAddress != rhs.validatorAddress {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Confio_Poe_V1beta1_QueryValidatorEngagementRewardResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QueryValidatorEngagementRewardResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "reward"),
  ]
  ...
  static func ==(lhs: Confio_Poe_V1beta1_QueryValidatorEngagementRewardResponse, rhs: Confio_Poe_V1beta1_QueryValidatorEngagementRewardResponse) -> Bool {
    if lhs._reward != rhs._reward {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
