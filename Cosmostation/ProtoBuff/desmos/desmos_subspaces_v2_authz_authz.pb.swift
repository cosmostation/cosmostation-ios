...
struct Desmos_Subspaces_V2_Authz_GenericSubspaceAuthorization {
...
extension Desmos_Subspaces_V2_Authz_GenericSubspaceAuthorization: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "desmos.subspaces.v2.authz"

extension Desmos_Subspaces_V2_Authz_GenericSubspaceAuthorization: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Subspaces_V2_Authz_GenericSubspaceAuthorization, rhs: Desmos_Subspaces_V2_Authz_GenericSubspaceAuthorization) -> Bool {
