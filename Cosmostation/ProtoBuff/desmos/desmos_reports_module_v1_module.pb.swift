...
struct Desmos_Reports_Module_V1_Module {
...
extension Desmos_Reports_Module_V1_Module: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "desmos.reports.module.v1"

extension Desmos_Reports_Module_V1_Module: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Reports_Module_V1_Module, rhs: Desmos_Reports_Module_V1_Module) -> Bool {
