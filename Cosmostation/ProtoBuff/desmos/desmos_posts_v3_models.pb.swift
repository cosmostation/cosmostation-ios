...
enum Desmos_Posts_V3_PostReferenceType: SwiftProtobuf.Enum {
...
extension Desmos_Posts_V3_PostReferenceType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Desmos_Posts_V3_PostReferenceType] = [
    .unspecified,
    .reply,
    .quote,
    .repost,
...
enum Desmos_Posts_V3_ReplySetting: SwiftProtobuf.Enum {
  typealias RawValue = Int
...
extension Desmos_Posts_V3_ReplySetting: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Desmos_Posts_V3_ReplySetting] = [
    .unspecified,
    .everyone,
    .followers,
    .mutual,
...
struct Desmos_Posts_V3_Post {
  ...
  var entities: Desmos_Posts_V3_Entities {
    get {return _storage._entities ?? Desmos_Posts_V3_Entities()}
  ...
  var replySettings: Desmos_Posts_V3_ReplySetting {
...
struct Desmos_Posts_V3_PostReference {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Type of reference
  var type: Desmos_Posts_V3_PostReferenceType = .unspecified
...
struct Desmos_Posts_V3_Entities {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Hashtags represent inside the post text
  var hashtags: [Desmos_Posts_V3_TextTag] = []

  /// Mentions present inside the post text
  var mentions: [Desmos_Posts_V3_TextTag] = []

  /// Links present inside the post text
  var urls: [Desmos_Posts_V3_Url] = []
...
struct Desmos_Posts_V3_TextTag {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Desmos_Posts_V3_Attachment {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Desmos_Posts_V3_Poll {
  ...
  var providedAnswers: [Desmos_Posts_V3_Poll.ProvidedAnswer] = []
  ...
  /// Final poll results
  var finalTallyResults: Desmos_Posts_V3_PollTallyResults {
    get {return _finalTallyResults ?? Desmos_Posts_V3_PollTallyResults()}
  ...
  fileprivate var _finalTallyResults: Desmos_Posts_V3_PollTallyResults? = nil
}

/// UserAnswer represents a user answer to a poll
struct Desmos_Posts_V3_UserAnswer {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Desmos_Posts_V3_PollTallyResults {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var results: [Desmos_Posts_V3_PollTallyResults.AnswerResult] = []
...
extension Desmos_Posts_V3_PostReferenceType: @unchecked Sendable {}
extension Desmos_Posts_V3_ReplySetting: @unchecked Sendable {}
extension Desmos_Posts_V3_Post: @unchecked Sendable {}
extension Desmos_Posts_V3_PostReference: @unchecked Sendable {}
extension Desmos_Posts_V3_Entities: @unchecked Sendable {}
extension Desmos_Posts_V3_TextTag: @unchecked Sendable {}
extension Desmos_Posts_V3_Url: @unchecked Sendable {}
extension Desmos_Posts_V3_Attachment: @unchecked Sendable {}
extension Desmos_Posts_V3_Media: @unchecked Sendable {}
extension Desmos_Posts_V3_Poll: @unchecked Sendable {}
extension Desmos_Posts_V3_Poll.ProvidedAnswer: @unchecked Sendable {}
extension Desmos_Posts_V3_UserAnswer: @unchecked Sendable {}
extension Desmos_Posts_V3_PollTallyResults: @unchecked Sendable {}
extension Desmos_Posts_V3_PollTallyResults.AnswerResult: @unchecked Sendable {}
extension Desmos_Posts_V3_Params: @unchecked Sendable {}
...
extension Desmos_Posts_V3_PostReferenceType: SwiftProtobuf._ProtoNameProviding {
...
extension Desmos_Posts_V3_ReplySetting: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Desmos_Posts_V3_Post: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _entities: Desmos_Posts_V3_Entities? = nil
    var _tags: [String] = []
    var _author: String = String()
    var _conversationID: UInt64 = 0
    var _referencedPosts: [Desmos_Posts_V3_PostReference] = []
    var _replySettings: Desmos_Posts_V3_ReplySetting = .unspecified
  ...
  static func ==(lhs: Desmos_Posts_V3_Post, rhs: Desmos_Posts_V3_Post) -> Bool {
...
extension Desmos_Posts_V3_PostReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Posts_V3_PostReference, rhs: Desmos_Posts_V3_PostReference) -> Bool {
...
extension Desmos_Posts_V3_Entities: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Posts_V3_Entities, rhs: Desmos_Posts_V3_Entities) -> Bool {
...
extension Desmos_Posts_V3_TextTag: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Posts_V3_TextTag, rhs: Desmos_Posts_V3_TextTag) -> Bool {
...
extension Desmos_Posts_V3_Url: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Posts_V3_Url, rhs: Desmos_Posts_V3_Url) -> Bool {
    if lhs.start != rhs.start {return false}
    if lhs.end != rhs.end {return false}
...
extension Desmos_Posts_V3_Attachment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Posts_V3_Attachment, rhs: Desmos_Posts_V3_Attachment) -> Bool {
...
extension Desmos_Posts_V3_Media: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Posts_V3_Media, rhs: Desmos_Posts_V3_Media) -> Bool {
...
extension Desmos_Posts_V3_Poll: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Posts_V3_Poll, rhs: Desmos_Posts_V3_Poll) -> Bool {
...
extension Desmos_Posts_V3_Poll.ProvidedAnswer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Desmos_Posts_V3_Poll.protoMessageName + ".ProvidedAnswer"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "text"),
  ...
  static func ==(lhs: Desmos_Posts_V3_Poll.ProvidedAnswer, rhs: Desmos_Posts_V3_Poll.ProvidedAnswer) -> Bool {
...
extension Desmos_Posts_V3_UserAnswer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Posts_V3_UserAnswer, rhs: Desmos_Posts_V3_UserAnswer) -> Bool {
    if lhs.subspaceID != rhs.subspaceID {return false}
    if lhs.postID != rhs.postID {return false}
...
extension Desmos_Posts_V3_PollTallyResults: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Posts_V3_PollTallyResults, rhs: Desmos_Posts_V3_PollTallyResults) -> Bool {
...
extension Desmos_Posts_V3_PollTallyResults.AnswerResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Desmos_Posts_V3_PollTallyResults.protoMessageName + ".AnswerResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Desmos_Posts_V3_PollTallyResults.AnswerResult, rhs: Desmos_Posts_V3_PollTallyResults.AnswerResult) -> Bool {
...
extension Desmos_Posts_V3_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Desmos_Posts_V3_Params, rhs: Desmos_Posts_V3_Params) -> Bool {
