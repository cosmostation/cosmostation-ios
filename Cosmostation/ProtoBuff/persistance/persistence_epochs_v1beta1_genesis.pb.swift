...
struct Persistence_Epochs_V1beta1_EpochInfo {
...
struct Persistence_Epochs_V1beta1_GenesisState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Persistence_Epochs_V1beta1_EpochInfo: @unchecked Sendable {}
extension Persistence_Epochs_V1beta1_GenesisState: @unchecked Sendable {}
...
extension Persistence_Epochs_V1beta1_EpochInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Persistence_Epochs_V1beta1_EpochInfo, rhs: Persistence_Epochs_V1beta1_EpochInfo) -> Bool {
...
extension Persistence_Epochs_V1beta1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Persistence_Epochs_V1beta1_GenesisState, rhs: Persistence_Epochs_V1beta1_GenesisState) -> Bool {
