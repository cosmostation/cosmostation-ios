...
extension Sifnode_Clp_V1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedStringField(value: &self.addressWhitelist) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.poolList) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.liquidityProviders) }()
      default: break
      }
    }
  }
